...
export const baseURL = 
    process.env.NEXT_PUBLIC_SERVER_URL || process.env.NEXT_PUBLIC_SERVER_URL1 || "http://localhost:5000";

export const clientURL = 
    process.env.NEXT_PUBLIC_CLIENT_URL || process.env.NEXT_PUBLIC_CLIENT_URL1 || "http://localhost:3000";
