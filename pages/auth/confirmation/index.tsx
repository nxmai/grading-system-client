...
function Confirmation() {
    ...
    return (
        ...
        <div className='h-screen flex justify-center items-center text-sm font-semibold leading-none tracking-tight text-[#19283E]'>
            <div className="relative w-[370px] h-[400px] flex justify-center items-center bg-[#FEFAF3] rounded-[15px] shadow-md">
                ...
                <div className="w-[320px] h-[350px] flex flex-col justify-center bg-white rounded-[5px]">
                    <div className='flex flex-col gap-5'>
                        <h1 className='pl-[35px] font-bold text-[34px] leading-[40px]'>We've just sent you an email confirmation.</h1>
                        <h1 className='pl-[35px] text-normal text-gray-400'>Haven't received yet? 🤔</h1>
